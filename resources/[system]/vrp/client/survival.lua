...
AddEventHandler("vRP:playerActive",function(user_id,name,players)
	...
	SetDiscordAppId(1025987180226695208)

	SetDiscordRichPresenceAsset("https://imgur.com/a/PA1xLah.png")
	SetDiscordRichPresenceAssetText("CreationV5 Plus")

	SetRichPresence("Players: "..players.. "/2048\n"..user_id.." | "..name)
