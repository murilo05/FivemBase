...
local preset = {
	...
	["5"] = {
		["mp_m_freemode_01"] = {
			["hat"] = { item = 104, texture = 20},
			["pants"] = { item = 87, texture = 1 },
			["vest"] = { item = 6, texture = 3 },
			["bracelet"] = { item = -1, texture = 0 },
			["backpack"] = { item = 0, texture = 0 },
			["decals"] = { item = 0, texture = 0 },
