		...
		if not LocalPlayer["state"]["Commands"] and not LocalPlayer["state"]["Handcuff"] and not menuOpen and MumbleIsConnected() then
			...
			if GetEntityHealth(ped) > 101 then
				...
				if LocalPlayer["state"]["Police"] then
					...
					exports["dynamic"]:AddButton("Aluno","Fardamento de oficial.","player:presetFunctions","11","prePolice",true)
					exports["dynamic"]:AddButton("RPM","Fardamento de oficial.","player:presetFunctions","1","prePolice",true)
					exports["dynamic"]:AddButton("SPEED","Fardamento de oficial.","player:presetFunctions","2","prePolice",true)
					...
					exports["dynamic"]:AddButton("CORE","Fardamento de oficial.","player:presetFunctions","5","prePolice",true)
